...
from flask_login import login_user, current_user, login_required, login_remembered, logout_user
...
def register():
    ...
    if form.validate_on_submit():
        hash_password = bcrpyt.generate_password_hash(form.password.data).decode('utf-8')
